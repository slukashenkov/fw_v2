'''
Support for proprietary messages from TRANSAS AIS.
'''
...
class PC(nmea.ProprietarySentence):
    '''
    PCMST TRANSAS Response Message
    '''
    sentence_types = {}
    def __new__(_cls,
                manufacturer,
        ...
        '''
        cls = _cls.sentence_types.get(name, PC)
        return super(PC, cls).__new__(cls)


class MST(PC):
    '''
    PCMST proprietary status attitude sentence
    '''
    @staticmethod
    def match(data):
    ...
    def __init__(self, *args, **kwargs):
        self.subtype = 'MST'
        super(MST, self).__init__(*args, **kwargs)

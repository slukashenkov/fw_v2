...
def encode (params,
    ...
    bvList = []
    bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 5), 6))
    ...
    if 'AISversion' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['AISversion']), 2))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 0), 2))
    
    if 'IMOnumber' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['IMOnumber']), 30))
    else:
    ...
    if 'fixtype' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['fixtype']), 4))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 0), 4))
    
    if 'ETAmonth' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['ETAmonth']), 4))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 0), 4))
    if 'ETAday' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['ETAday']), 5))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 0), 5))
    if 'ETAhour' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['ETAhour']), 5))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 24), 5))
    if 'ETAminute' in params:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['ETAminute']), 6))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = 60), 6))
    
    if 'draught' in params:
        bvList.append(
            aisbinary.setBitVectorSize(BitVector(intVal = int((Decimal(params['draught']) * Decimal('10')))), 8))
    else:
        bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = int(0)), 8))
    if 'destination' in params:
        bvList.append(aisstring.encode(params['destination'], 120))
    else:
        bvList.append(aisstring.encode('@@@@@@@@@@@@@@@@@@@@', 120))
    
    bvList.append(aisbinary.setBitVectorSize(BitVector(intVal = params['dte']), 1))
...
def addMsgOptions (parser):
    ...
    parser.add_option('--IMOnumber-field', dest = 'IMOnumberField', default = 0, metavar = 'uint', type = 'int'
                      , help = 'Field parameter value [default: %default]')
    parser.add_option('--callsign-field', dest = 'callsignField', default = '@@@@@@@', metavar = 'aisstr6',
                      type = 'string'
                      , help = 'Field parameter value [default: %default]')
    parser.add_option('--name-field', dest = 'nameField', default = '@@@@@@@@@@@@@@@@@@@@', metavar = 'aisstr6',
                      type = 'string'
                      , help = 'Field parameter value [default: %default]')
    parser.add_option('--shipandcargo-field', dest = 'shipandcargoField', default = 0, metavar = 'uint',
                      type = 'int'
                      , help = 'Field parameter value [default: %default]')
    ...
    parser.add_option('--ETAminute-field', dest = 'ETAminuteField', default = 60, metavar = 'uint', type = 'int'
                      , help = 'Field parameter value [default: %default]')
    parser.add_option('--draught-field', dest = 'draughtField', default = Decimal('0'), metavar = 'udecimal',
                      type = 'string'
                      , help = 'Field parameter value [default: %default]')
    parser.add_option('--destination-field', dest = 'destinationField', default = '@@@@@@@@@@@@@@@@@@@@',
                      metavar = 'aisstr6', type = 'string'
                      , help = 'Field parameter value [default: %default]')

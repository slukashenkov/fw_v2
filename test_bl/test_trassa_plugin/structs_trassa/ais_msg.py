...
from test_bl.test_trassa_plugin.structs_trassa.aisutils.types import ais_msg_1, ais_msg_5, ais_msg_18, ais_msg_24
...
class AisMsg():
    ...
    def get_type_24(self,
                    type="A" #Can be B and aux. A and B should be tested aux was done just in case
                    ):
        msg24_a = {}
        msg24_b = {}
        msg24_aux = {}
        ...
        bits_a = ais_msg_24.encode(msg24_a,
                                 type="A")
        bits_b = ais_msg_24.encode(msg24_b,
                                    type="B")
        bits_aux = ais_msg_24.encode(msg24_aux,
                                    type="aux")
...
def test_this():
    ...
    # stuct for sending
    test_ais['type_1'] = ais_msg.get_type_1()
    test_ais['type_5'] = ais_msg.get_type_5()
    test_ais['type_18'] = ais_msg.get_type_18()
    test_ais['type_24_a'] = ais_msg.get_type_24(type="A")
    test_ais['type24_b'] = ais_msg.get_type_24(type="B")
    test_ais['type24_aux'] = ais_msg.get_type_24(type="aux")

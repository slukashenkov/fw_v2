...
from test_bl.test_trassa_plugin.structs_trassa.nmeautils.types.proprietary import aid, ais, cms, eis
...
class NmeaMsg():
    ...
    def get_pa_idd (self):
        ...
        return str(
            talker.IDD('PA', 'IDD', ('7776666', '89.5', 'N', '67.0', 'E', '67', '30.7', '32.5', '111430.07')))
